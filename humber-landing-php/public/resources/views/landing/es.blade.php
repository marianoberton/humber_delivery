        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-300">
                ...
                <div class="text-center md:text-right">
                    ...
                    <ul class="space-y-2 text-gray-300">
                        <li>AR: <a href="https://wa.me/{{ $waAr }}" class="hover:text-[#fcc007] transition-colors">{{ config('leads.whatsapp.ar') }}</a></li>
                        <li>CL: <a href="https://wa.me/{{ $waCl }}" class="hover:text-[#fcc007] transition-colors">{{ config('leads.whatsapp.cl') }}</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="fab-whatsapp">
        <div class="fab-options">
            <div class="bg-white rounded-lg shadow-lg p-2 space-y-2 min-w-48">
                <a href="https://wa.me/{{ $waAr }}" target="_blank" 
