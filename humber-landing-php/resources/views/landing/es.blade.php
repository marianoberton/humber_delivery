...
@section('content')
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-300">
                ...
                <div class="text-center md:text-right">
                    ...
                    <ul class="space-y-2 text-gray-300">
                        <li>AR: <a href="tel:+5491123456789" class="hover:text-[#fcc007] transition-colors">+54 9 11 2345-6789</a></li>
                        <li>CL: <a href="tel:+56987654321" class="hover:text-[#fcc007] transition-colors">+56 9 8765-4321</a></li>
                        <li>BR: <a href="tel:+5511987654321" class="hover:text-[#fcc007] transition-colors">+55 11 9 8765-4321</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="fab-whatsapp">
        <div class="fab-options">
            <div class="bg-white rounded-lg shadow-lg p-2 space-y-2 min-w-48">
                ...
                <a href="https://wa.me/56987654321" target="_blank" 
                   class="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Elementos para la animación cinematográfica
            const elements = [
